...
const Produk = () => {
    ...
    return (
        <div style={styleProduk}>
            {
                listProduct.map((value, index) => {
                    return <CardProduk key={index} namaProduk={value.productName} hargaProduk={value.productPrice} imgUrl={value.urlImage} myAlert={() => {
                        alert('Produk ' + value.productName + ' Dengan Harga ' + value.productPrice + ' Adalah Produk Terbaik Sejagat Raya:v')
                    }} />
                })
            }
        </div>
